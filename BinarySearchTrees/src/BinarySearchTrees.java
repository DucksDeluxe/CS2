	...
	public static void main(String[] args) 
	{
		...
		for ( int i=0; i<scrambled.length; i++ )
		{
			if( m_objBST.Search(scrambled[i]) == null)
				...
				System.out.println(scrambled[i] + "=" + m_objBST.Search(scrambled[i]).GetKeyValue() + " Subtree Size: " + m_objBST.Search(scrambled[i]).getM_nSubTreeSize() + " Rank: " + m_objBST.Search(scrambled[i]).getM_nRank());
		}
